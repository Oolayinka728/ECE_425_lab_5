...
void Stepper_Motor_Init()
{
	...
	//Configurre the PB0, PB1, PB2, and PB3 pins as output
	//by setting Bits 3 to 0 in the DIR register
	GPIOB -> DIR |= 0x0F;
	
	//Configure the PB0, PB1, PB2, and PB3 pins to functino as
	//GPIO pins by clearinf Bits 3 to 0 in the AFSEL registerr
	GPIOB ->AFSEL &= ~0x0F;
	
	//Enable the digital functinoality for the PB0, PB1, PB2,a dn PB3 pins
	...
	//GPIO pins by clearing the Bits 3 to 2 in the AFSEL register
	GPIOF->AFSEL &=~0x0C;
	...
	//Initialize the output of the PF3 and PF2 in the DATA register
	GPIOF->DATA |=0x0C;
}
